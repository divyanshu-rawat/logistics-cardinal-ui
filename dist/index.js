...
var SingleSelect = function (_PureComponent) {
  ...
  function SingleSelect() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = SingleSelect.__proto__ || Object.getPrototypeOf(SingleSelect)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
...
var MultipleSelect = function (_PureComponent) {
  ...
  function MultipleSelect() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = MultipleSelect.__proto__ || Object.getPrototypeOf(MultipleSelect)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      selectedValue: _this.props.initialValue
...
(function (root, factory) {
	...
	if (major < 2 || (major === 2 && minor < 6)) {
		logError('Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js ' + moment$$1.version + '. See momentjs.com');
	}
	...
	************************************/
	...
	moment$$1.tz.setDefault = function(name) {
		if (major < 2 || (major === 2 && minor < 9)) {
			logError('Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js ' + moment$$1.version + '.');
		}
...
var TimeSpanDisplay$1 = function TimeSpanDisplay$$1(_ref) {
  ...
  return React__default.createElement(
    React.Fragment,
    null,
    React__default.createElement(TimeSpanDisplay, { date: startAt, withSeconds: withSeconds }),
    ' \u2014',
    ' ',
    React__default.createElement(TimeSpanDisplay, { date: endAt, withSeconds: withSeconds })
  );
};
